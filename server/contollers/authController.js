...
export const register = catchAsyncErrors(async (req, res, next) => {
    ...
    try {
        ...
        if(registrationAttemptsByUser.length >=5){
            return next(new ErrorHandler("You have exeeded the number of registration attemps.Please contact support.", 400)
        );
        }
...
export const login = catchAsyncErrors(async(req, res, next) => {
    ...
    sendToken(user, 200, "User login sucssessfully.", res);
